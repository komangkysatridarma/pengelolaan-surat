...
<form method="post" action="{{ route('klaf.update', $letter_type['id']) }}">
    ...
    <div class="mb-6">
      ...
      <input type="name_type" id="name_type" name="name_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('name_type') is-invalid @enderror" value="{{ old('name_type', $letter_type->name_type) }}" required>
